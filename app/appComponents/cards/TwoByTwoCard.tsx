...
const TwoByTwoCard: React.FC<Props> = ({
  style,
  onPress,
  image,
  isPremium = false,
  ...
  return (
    ...
    >
      ...
      <Animated.View style={[styles.viewContainer, cardAnimatedStyle]}>
        <AppFastImage source={{ uri: image }} style={styles.image} contentFit="fill"/>
      </Animated.View>
    </TouchableOpacity>
  );
};
...
const getDynamicStyles = () => {
  ...
  return StyleSheet.create({
    container: {
      width: constants.windowWidth / 1.6,
      height: constants.windowHeight / 6.4,
